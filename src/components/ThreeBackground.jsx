...
const ThreeBackground = () => {
    ...
    useEffect(() => {
        ...
        // The original code calculated aspect ratio but sometimes window.innerWidth/Height isn't available right away
        ...
        const animate = () => {
            ...
            particles.rotation.x += (mousePos.current.y - particles.rotation.x) * 0.05;
            particles.rotation.y += (mousePos.current.x - particles.rotation.y) * 0.05;
    ...
    // Changed fixed inset-0 to block w-full h-full to make sure it fills
